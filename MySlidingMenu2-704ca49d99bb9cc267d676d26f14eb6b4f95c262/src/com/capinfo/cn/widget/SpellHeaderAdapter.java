...
public abstract class SpellHeaderAdapter extends BaseAdapter implements
...
//		LinearLayout item_list_head = (LinearLayout) res
//				.findViewById(R.id.item_list_head);
//		if(item_list_head.getVisibility() == View.VISIBLE){
//			item_list_head.setClickable(true);
//		}
	...
	public abstract int getSelectSideBar(String str);
}
